...
# データ読み込み
df = pd.read_csv("../data/output/random_test/1.data_shaping_1day.csv", encoding="shift_jis")
...
# グラフのレイアウト調整・保存
plt.tight_layout()
plt.savefig("../data/output/random_test/2.0.regression_all_steps.png", dpi=300, bbox_inches='tight')

# 回帰係数・切片を保存
cut.to_csv("../data/output/random_test/2.1.回帰係数・切片.csv", encoding="shift_jis", index=False)