...
for t in range(T+1):
        for i in range(I):
                P_DW[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#上げ調整力
vt = gp.GRB.CONTINUOUS
vn = 'Power_of_BESS_UP'
UB = gp.GRB.INFINITY
...
for t in range(T+1):
        for i in range(I):
                P_UP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#放電における上げ調整力
vt = gp.GRB.CONTINUOUS
vn = 'Discharging_Power_of_BESS_UP'
UB = gp.GRB.INFINITY
LB = 0.0
P_UP_DCh={}
for t in range(T+1):
        for i in range(I):
                P_UP_DCh[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#充電における下げ調整力
vt = gp.GRB.CONTINUOUS
vn = 'Charging_Power_of_BESS_DW'
UB = gp.GRB.INFINITY
LB = 0.0
P_DW_Ch={}
for t in range(T+1):
     for i in range(I):
        P_DW_Ch[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#充電における上げ調整力
vt = gp.GRB.CONTINUOUS
vn = 'Charging_Power_of_BESS_UP'
UB = gp.GRB.INFINITY
LB = 0.0
P_UP_Ch={}
for t in range(T+1):
    for i in range(I):
        P_UP_Ch[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#放電における下げ調整力
vt = gp.GRB.CONTINUOUS
vn = 'Discharging_Power_of_BESS_DW'
UB = gp.GRB.INFINITY
LB = 0.0
P_DW_DCh={}
for t in range(T+1):
    for i in range(I):
        P_DW_DCh[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
#調整電力
vt = gp.GRB.CONTINUOUS
vn = 'Shiftable_Electricity'
UB = gp.GRB.INFINITY
LB = -gp.GRB.INFINITY
P_SP = {}
for t in range(T+1):
    for i in range(I):
        P_SP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(1,T+1):
    for i in range(I):
        P_pg_UP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#調整力が発動した場合の電力系統との取引量[kW] 
vt = gp.GRB.CONTINUOUS
vn = 'Purchacing_Power_of_HEMS'
UB = gp.GRB.INFINITY
...
for t in range(1,T+1):
    for i in range(I):
        P_pg_DW[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
# 売電電力[kW]
vt = gp.GRB.CONTINUOUS
...
for t in range(1,T+1):
    for i in range(I):
        P_HP_UP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(1,T+1):
    for i in range(I):
        P_HP_DW[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        E_B_DW[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        E_B_UP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        E_B_UP_minus[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        E_B_DW_plus[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        H_tank_UP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        H_tank_DW[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
...
for t in range(0,T+1):
    for i in range(I):
        H_prod_UP[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#下げ調整力による貯湯量の増加量
vt = gp.GRB.CONTINUOUS
vn = 'produce_heat_UP'
UB = gp.GRB.INFINITY
...
for t in range(0,T+1):
    for i in range(I):
        H_prod_DW[t,i] = AG_PM.addVar(vtype=vt,name=vn+'({:})'.format(t),lb=LB,ub=UB)
#貯湯量
vt = gp.GRB.CONTINUOUS
vn = 'tank_heat'
UB = gp.GRB.INFINITY
...
for t in range(1, T+1):
    for k in range(I): 
        V_d_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(1, T+1):
    for k in range(I): 
        V_d_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(0, T+1):
    for k in range(I): 
        V_dd_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(0, T+1):
    for k in range(I): 
        V_dd_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(1, T+1):
    for k in range(I): 
        ap_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(1, T+1):
    for k in range(0,I): 
        aq_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(1, T+1):
    for k in range(I): 
        ap_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(1, T+1):
    for k in range(0,I): 
        aq_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)
...
for t in range(1, T+1):
    for k in range(0,I): 
        V_UN_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1, T+1):
    for k in range(0,I): 
        V_UN_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1, T+1):
    for k in range(0,I): 
        V_LN_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1, T+1):
    for k in range(0,I): 
        V_LN_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1,T+1):
    for k in range(I): 
        V_ULV_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1,T+1):
    for k in range(I): 
        V_ULV_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1,T+1):
    for k in range(I): 
        V_LLV_DW[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for t in range(1,T+1):
    for k in range(I): 
        V_LLV_UP[t,k] = AG_PM.addVar(vtype=vt, name=vn + '({:},{:})'.format(t,k), lb=LB, ub=UB)  
...
for i in range(I):    
    ...
    for t in range(1,T+1):
        ...
        AG_PM.addConstr( P_pg_UP[t,i] == P_PG[t,i]-P_SG[t,i]+P_UP[t,i])
        AG_PM.addConstr( P_pg_DW[t,i] == P_PG[t,i]-P_SG[t,i]-P_DW[t,i])
    ...
    # 蓄電池蓄電容量（kWh容量）制約
    for t in range(1,T+1):
        AG_PM.addConstr(N_B*0.2 <= E_B[t,i]-E_B_DW[t,i])
        AG_PM.addConstr(E_B[t,i]+E_B_UP[t,i] <= N_B)
...
for t in range(1,T+1):
    for k in range(I): 
        ...
        AG_PM.addConstr(V_UL-V_d_UP[t,k] == V_UN_UP[t,k]-V_ULV_UP[t,k]) 
        AG_PM.addConstr(V_UL-V_d_DW[t,k] == V_UN_DW[t,k]-V_ULV_DW[t,k])  
#下限違反            
for t in range(1,T+1):
    for k in range(I):    
        AG_PM.addConstr(V_d[t,k]-V_LL == V_LN[t,k]-V_LLV[t,k])
        AG_PM.addConstr(V_d_UP[t,k]-V_LL == V_LN_UP[t,k]-V_LLV_UP[t,k])
        AG_PM.addConstr(V_d_DW[t,k]-V_LL == V_LN_DW[t,k]-V_LLV_DW[t,k])
#右辺の文字を0以上とする制約    
for t in range(1,T+1):
    for k in range(I):  
        ...
        AG_PM.addConstr( V_ULV_UP[t,k]>= 0)
        AG_PM.addConstr( V_UN_UP[t,k] >= 0)
        AG_PM.addConstr( V_LN_UP[t,k] >= 0)
        AG_PM.addConstr( V_LLV_UP[t,k]>= 0)
        AG_PM.addConstr( V_ULV_DW[t,k]>= 0)
        AG_PM.addConstr( V_UN_DW[t,k] >= 0)
        AG_PM.addConstr( V_LN_DW[t,k] >= 0)
        AG_PM.addConstr( V_LLV_DW[t,k]>= 0)
        
#電圧推定
for t in range(1,T+1): 
    for k in range(I):
        AG_PM.addConstr(V_dd[t,k]==linear_ap[k]*ap[t,k]+linear_aq[k]*aq[t,k]+linear_b[k])#電圧降下推定
        AG_PM.addConstr(V_dd_UP[t,k]==linear_ap[k]*ap_UP[t,k]+linear_aq[k]*aq_UP[t,k]+linear_b[k])
        AG_PM.addConstr(V_dd_DW[t,k]==linear_ap[k]*ap_DW[t,k]+linear_aq[k]*aq_DW[t,k]+linear_b[k])
            
for t in range(1,T+1):
    for k in range(I):
        if k==0:
            AG_PM.addConstr(V_d[t,k]==V_dd[t,k]+99.8)
            AG_PM.addConstr(V_d_UP[t,k]==V_dd_UP[t,k]+99.8)
            AG_PM.addConstr(V_d_DW[t,k]==V_dd_DW[t,k]+99.8)
            
        if k==1:
            AG_PM.addConstr(V_d[t,k]==V_dd[t,k]+V_d[t,0])
            AG_PM.addConstr(V_d_UP[t,k]==V_dd_UP[t,k]+V_d_UP[t,0])
            AG_PM.addConstr(V_d_DW[t,k]==V_dd_DW[t,k]+V_d_DW[t,0])
        if k==2:
            AG_PM.addConstr(V_d[t,k]==V_dd[t,k]+V_d[t,1])
            AG_PM.addConstr(V_d_UP[t,k]==V_dd_UP[t,k]+V_d_UP[t,1])
            AG_PM.addConstr(V_d_DW[t,k]==V_dd_DW[t,k]+V_d_DW[t,1])
...
for t in range(1,T+1):
         for k in range(I): 
                ...
                AG_PM.addConstr(ap_UP[t,k]==gp.quicksum(P_pg_UP[t,i] for i in range(k,I) ) )
                AG_PM.addConstr(aq_UP[t,k]==gp.quicksum(P_pg_UP[t,i] for i in range(k,I) )*0.1 )
                AG_PM.addConstr(ap_DW[t,k]==gp.quicksum(P_pg_DW[t,i] for i in range(k,I) ) )
                AG_PM.addConstr(aq_DW[t,k]==gp.quicksum(P_pg_DW[t,i] for i in range(k,I) )*0.1 )
