...
class CentralizedOptimizer:
    ...
    def setup_model(self):
        ...
        # 有効電力・無効電力・皮相電力（配電網側）
        self.P_flow = self.model.addVars(range(1, self.T+1), range(self.H), lb=-GRB.INFINITY, name="P_flow")
        self.Q_flow = self.model.addVars(range(1, self.T+1), range(self.H), lb=-GRB.INFINITY, name="Q_flow")
        ...
        self.V_H = self.model.addVars(range(1, self.T+1), range(self.H), lb=0, ub=GRB.INFINITY, name="V_H")
        self.model.update()
